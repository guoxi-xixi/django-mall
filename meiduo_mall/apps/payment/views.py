...
class PayUrlView(View):
    ...
    def get(self, request, order_id):
        ...
        order_string = alipay.api_alipay_trade_page_pay(
            ...
            total_amount=str(order_info.total_amount),  # 一定要进行类型转换,因为decimal不是基本数据类型
            subject=subject,
...
class PaymentStatusView(View):
    ...
    def put(self, request):
        ...
        if success:
            # 读取 -> trade_no	String	必填	64	支付宝交易号
            ...
            # 5. 返回响应
            return JsonResponse({'code': 0, 'msg': 'ok', 'trade_id': trade_no})
        else:
